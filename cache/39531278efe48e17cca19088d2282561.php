            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a  class="active-menu" href="index.php?m=admin&c=ui&a=ui"><i class="fa fa-desktop fa-3x"></i> 用户管理</a>
                    </li>
                     <li>
...
<html>
    ...
    <body>
        ...
        <div class="member">
            ...
            <form action="index.php?m=admin&c=ui&a=ui" method="post">
                <table cellspacing="0">
                    <tr>
                        <td></td>
                        <td><b>用户名</b></td>
                    ...
                    <?php foreach ($user as $value): ?>
                            ...
                            <?php if (empty($value['islock'])): ?>
                                    <td class="details"><a href="index.php?m=admin&c=ui&a=ui&id=<?=$value['id']; ?>">锁定用户</a></td>
                            <?php else: ?>    
                                    <td class="details"><a href="index.php?m=admin&c=ui&a=ui&id=<?=$value['id']; ?>">解锁</a></td>
                            <?php endif; ?>
                            </tr>
                    <?php endforeach; ?>  
                    <tr>
