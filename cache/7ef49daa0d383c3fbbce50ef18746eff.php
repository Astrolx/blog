...
<html>
    ...
    <body>
        ...
        <div class="post">
            ...
            <form action="index.php?m=admin&c=blogs&a=blogs" method="post">
                <ul class="headline">
                    <li name="title">标题</li>
                    ...
                    <?php foreach ($result as $value): ?>
                        <?php if ($value['istrash'] == 0): ?>          
                            <ul class="content">
                                ...
                                <li style="clear:both;width:50px; margin-top:-35px;margin-left:1050px;"><a href="index.php?m=admin&c=edit&a=edit&id=<?=$value['id']; ?>">编辑</a></li>
                            </ul>  
                        <?php endif; ?> 
                    <?php endforeach; ?>             
                <?php endif; ?>
                    ...
                    <?php foreach ($result as $value): ?>
                        <?php if ($value['istrash'] == 1): ?>          
                            <ul class="content">
                                ...
                                <li style="clear:both;width:50px; margin-top:-35px;margin-left:1050px;"><a href="index.php?m=admin&c=blogs&a=blogs&id=<?=$value['id']; ?>">删除</a></li>
                            </ul>  
                        <?php endif; ?> 
                    <?php endforeach; ?>             
                <?php endif; ?>
