           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li>
                        <a  class="active-menu" href="index.php?m=admin&c=category&a=category"><i class="fa fa-qrcode fa-3x"></i> 版块管理</a>
                    </li>
                          <!--  <li  >
                ...
                <?php foreach ($result as $value): ?>
                        <div class="listI">
                           <!--  <input type="text" class="orderby" name="orderby[]" value="{}" /> -->
                            ...
                            <a href="index.php?m=admin&c=category&a=category&id=<?=$value['id']; ?>&cid=<?=$value['cid']; ?>" >删除</a>
...
<html>
    ...
    <body >
        ...
        <div class="addmodule">
            ...
            <form action="index.php?m=admin&c=category&a=category" method="post">
                <ul>
