           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li  >
                        <a class="active-menu" href="index.php?m=admin&c=comment&a=comment"><i class="fa fa-edit fa-3x"></i> 评论管理</a>
                    </li>   
                    <li  >
...
<html>
    ...
    <body>
        ...
        <div class="post">
            ...
            <form action="index.php?m=admin&c=comment&a=comment" method="post">
                <table cellspacing="0">
                    <tr>
                        <td class="select"></td>
