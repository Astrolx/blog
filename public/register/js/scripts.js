...
jQuery(document).ready(function() {
    ...
    */
    $.backstretch([
      "public/register/img/backgrounds/img (1).jpg"
    , "public/register/img/backgrounds/img (2).jpg"
    , "public/register/img/backgrounds/img (3).jpg"
    ...
    */
    $('.register form').submit(function(){
        ...
        $(this).find("label[for='email']").html('Password');
        ...
        if(email == '') {
            $(this).find("label[for='email']").append("<span style='display:none' class='red'> - 请输入密码.</span>");
            $(this).find("label[for='email'] span").fadeIn('medium');
            return false;
        }
        if(password == '') {
            $(this).find("label[for='password']").append("<span style='display:none' class='red'> - 请再次输入密码.</span>");
